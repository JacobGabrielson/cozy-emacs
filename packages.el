...
;; Provides the icon glyphs doom-modeline renders. Run
;; `M-x nerd-icons-install-fonts' once to install the Symbols Nerd Font
;; Mono ttf into ~/Library/Fonts; otherwise the modeline shows tofu boxes.
...
(with-eval-after-load 'org-agenda
  ;; Replaces the default `D' (org-agenda-deadline).
...
;; Shellcheck is required for sh-mode flycheck to work; see setups/INSTALL.md.
